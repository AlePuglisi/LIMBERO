...
#include "custom_joint_trajectory_controller/custom_joint_trajectory_controller.hpp"
...
#include "custom_joint_trajectory_controller/trajectory.hpp"
...
{
CustomJointTrajectoryController::CustomJointTrajectoryController()
: controller_interface::ControllerInterface(), dof_(0)
{
}

controller_interface::CallbackReturn CustomJointTrajectoryController::on_init()
{
  try
  {
...
CustomJointTrajectoryController::command_interface_configuration() const
{
...
controller_interface::InterfaceConfiguration
CustomJointTrajectoryController::state_interface_configuration() const
{
  controller_interface::InterfaceConfiguration conf;
  conf.type = controller_interface::interface_configuration_type::INDIVIDUAL;
...
controller_interface::return_type CustomJointTrajectoryController::update(
...
void CustomJointTrajectoryController::read_state_from_state_interfaces(JointTrajectoryPoint & state)
{
...
bool CustomJointTrajectoryController::read_state_from_command_interfaces(JointTrajectoryPoint & state)
{
...
bool CustomJointTrajectoryController::read_commands_from_command_interfaces(
...
void CustomJointTrajectoryController::query_state_service(
...
controller_interface::CallbackReturn CustomJointTrajectoryController::on_configure(
  const rclcpp_lifecycle::State &)
{
  ...
  joint_command_subscriber_ =
    get_node()->create_subscription<trajectory_msgs::msg::JointTrajectory>(
      ...
      std::bind(&CustomJointTrajectoryController::topic_callback, this, std::placeholders::_1));
  ...
  action_server_ = rclcpp_action::create_server<FollowJTrajAction>(
    ...
    std::bind(&CustomJointTrajectoryController::goal_received_callback, this, _1, _2),
    std::bind(&CustomJointTrajectoryController::goal_cancelled_callback, this, _1),
    std::bind(&CustomJointTrajectoryController::goal_accepted_callback, this, _1));
  ...
  query_state_srv_ = get_node()->create_service<control_msgs::srv::QueryTrajectoryState>(
    ...
    std::bind(&CustomJointTrajectoryController::query_state_service, this, _1, _2));

  return CallbackReturn::SUCCESS;
}

controller_interface::CallbackReturn CustomJointTrajectoryController::on_activate(
  const rclcpp_lifecycle::State &)
{
  auto logger = get_node()->get_logger();
...
controller_interface::CallbackReturn CustomJointTrajectoryController::on_deactivate(
  const rclcpp_lifecycle::State &)
{
...
controller_interface::CallbackReturn CustomJointTrajectoryController::on_cleanup(
  const rclcpp_lifecycle::State &)
{
  return CallbackReturn::SUCCESS;
}

controller_interface::CallbackReturn CustomJointTrajectoryController::on_error(
  const rclcpp_lifecycle::State &)
{
  if (!reset())
  {
...
bool CustomJointTrajectoryController::reset()
{
  subscriber_is_active_ = false;
...
controller_interface::CallbackReturn CustomJointTrajectoryController::on_shutdown(
  const rclcpp_lifecycle::State &)
{
...
void CustomJointTrajectoryController::publish_state(
...
void CustomJointTrajectoryController::topic_callback(
  const std::shared_ptr<trajectory_msgs::msg::JointTrajectory> msg)
{
  ...
  // http://wiki.ros.org/custom_joint_trajectory_controller/UnderstandingTrajectoryReplacement
...
rclcpp_action::GoalResponse CustomJointTrajectoryController::goal_received_callback(
...
rclcpp_action::CancelResponse CustomJointTrajectoryController::goal_cancelled_callback(
...
void CustomJointTrajectoryController::goal_accepted_callback(
...
void CustomJointTrajectoryController::fill_partial_goal(
...
void CustomJointTrajectoryController::sort_to_local_joint_order(
...
bool CustomJointTrajectoryController::validate_trajectory_point_field(
...
bool CustomJointTrajectoryController::validate_trajectory_msg(
...
void CustomJointTrajectoryController::add_new_trajectory_msg(
  const std::shared_ptr<trajectory_msgs::msg::JointTrajectory> & traj_msg)
{
  traj_msg_external_point_ptr_.writeFromNonRT(traj_msg);
}

void CustomJointTrajectoryController::preempt_active_goal()
{
  const auto active_goal = *rt_active_goal_.readFromNonRT();
  if (active_goal)
  {
...
std::shared_ptr<trajectory_msgs::msg::JointTrajectory>
CustomJointTrajectoryController::set_hold_position()
{
...
std::shared_ptr<trajectory_msgs::msg::JointTrajectory>
CustomJointTrajectoryController::set_success_trajectory_point()
{
...
bool CustomJointTrajectoryController::contains_interface_type(
...
void CustomJointTrajectoryController::resize_joint_trajectory_point(
...
void CustomJointTrajectoryController::resize_joint_trajectory_point_command(
  trajectory_msgs::msg::JointTrajectoryPoint & point, size_t size)
{
  if (has_position_command_interface_)
  {
...
bool CustomJointTrajectoryController::has_active_trajectory() const
{
  return traj_external_point_ptr_ != nullptr && traj_external_point_ptr_->has_trajectory_msg();
}

void CustomJointTrajectoryController::update_pids()
{
  for (size_t i = 0; i < dof_; ++i)
  {
    const auto & gains = params_.gains.joints_map.at(params_.joints[i]);
    if (pids_[i])
    {
      ...
      pids_[i]->setGains(gains.kpv, gains.kiv, gains.kdv, gains.i_clamp, -gains.i_clamp, true);
    }
    else
    {
      // Init PIDs with gains from ROS parameters
      pids_[i] = std::make_shared<control_toolbox::Pid>(
        gains.kpv, gains.kiv, gains.kdv, gains.i_clamp, -gains.i_clamp, true);
    }
...
void CustomJointTrajectoryController::init_hold_position_msg()
{
...
PLUGINLIB_EXPORT_CLASS(
  custom_joint_trajectory_controller::CustomJointTrajectoryController, controller_interface::ControllerInterface)
