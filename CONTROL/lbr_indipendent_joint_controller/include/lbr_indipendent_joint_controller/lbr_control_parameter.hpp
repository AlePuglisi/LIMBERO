...
constexpr float KPV[JOINT_NUM] =  {50.0, 100.0, 90.0, 40.0, 70.0, 70.0, 0.0};       // Velocity P gains
constexpr float TIV[JOINT_NUM] = {0.1, 0.1, 0.1, 01.1, 0.1, 0.1, 1.0};                    // Velocity I gains
...
constexpr float WCP_F = 0.8; // [Hz] cut off frequency of reference position LP filter
...
constexpr float TC = TIV[0]*0.01; // anti-wind up feedback gain 
...
constexpr double Vff = 0.8; // variable for velocity feed forward action (between 0 and 1 to modulate the effect)
