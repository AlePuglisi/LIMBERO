...
constexpr float TIV[JOINT_NUM] = {0.5, 0.5, 0.5, 0.5, 0.5, 0.5, 1.0};                    // Velocity I gains
...
constexpr float WCV_F = 8.0; // [Hz] cut off frequency of velocity derivation (feed forward action) LP filter, for REALIZABILITY of derivative
